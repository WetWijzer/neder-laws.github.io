...
type AgentOperations = typeof internal.wetwijzer.agentOperations;

export async function runAgentOperation(ctx: MutationCtx, operation: string, args: any) {
  let reference;
  switch (operation) {
    case 'agentRememberConversation':
      reference = internal.wetwijzer.agentOperations.agentRememberConversation;
      break;
    case 'agentGenerateMessage':
      ...
      reference = internal.wetwijzer.clientAgentOperations.agentGenerateMessageClient;
      break;
    case 'agentDoSomething':
      // Use the new client-side version for consistency
      reference = internal.wetwijzer.clientAgentOperations.agentDoSomething;
      break;
    default:
