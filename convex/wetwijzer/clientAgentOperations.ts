...
export const agentGenerateMessageClient = internalAction({
  ...
  handler: async (ctx, args) => {
    ...
    const conversationContext = await ctx.runQuery(internal.wetwijzer.clientAgentOperations.getConversationContext, {
    ...
    await ctx.runMutation(internal.wetwijzer.clientAgentOperations.storeClientLLMRequest, {
      worldId: args.worldId,
  ...
  handler: async (ctx, args) => {
    ...
    if (!player.pathfinding) {
      if (recentActivity || justLeftConversation) {
        ...
        await ctx.runMutation(api.wetwijzer.main.sendInput, {
          worldId: args.worldId,
    ...
    const invitee =
      justLeftConversation || recentlyAttemptedInvite
        ? undefined
        : await ctx.runQuery(internal.wetwijzer.agent.findConversationCandidate, {
            now,
            worldId: args.worldId,
            player: args.player,
