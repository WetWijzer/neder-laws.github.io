...
class RobotsPolicyTests(unittest.TestCase):
    def test_disallow_blocks_longest_matching_path(self) -> None:
        ...
        blocked = robots.can_fetch("https://wetten.overheid.nl/ppd/private/case")
        allowed = robots.can_fetch("https://wetten.overheid.nl/ppd/private/public-summary")
    ...
    def test_no_matching_group_allows_by_default(self) -> None:
        ...
        decision = robots.can_fetch("https://wetten.overheid.nl/ppd")
...
class CrawlPolicyTests(unittest.TestCase):
    ...
    def test_allows_public_ppd_seed_after_robots(self) -> None:
        ...
        decision = self.policy.preflight("https://wetten.overheid.nl/ppd", robots_policy=robots)
        self.assertTrue(decision.allowed)
    ...
    def test_rejects_non_https_and_unlisted_hosts(self) -> None:
        self.assertEqual(
            self.policy.preflight("http://wetten.overheid.nl/ppd").reason_code,
            "scheme_not_https",
        )
        self.assertEqual(
    ...
    def test_rejects_private_or_consequential_devhub_paths(self) -> None:
        decision = self.policy.preflight("https://wetten.overheid.nl/my-permits/payment")
    ...
    def test_rejects_content_type_outside_phase_scope(self) -> None:
        decision = self.policy.preflight("https://wetten.overheid.nl/ppd", content_type="application/json")
        self.assertFalse(decision.allowed)
